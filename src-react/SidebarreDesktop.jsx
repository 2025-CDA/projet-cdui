...
import logo2 from "./assets/Frame 93.png"
...
// ------------------------------------ L'affichage ------------------------------------
  return (
    <div className={`flex flex-col h-screen bg-primary text-white 
        ${collapsed ? "w-20" : "w-60"} transition-all duration-300 relative rounded-tr-xl`}>

        {/* ------Avatar + Infos utilisateur ----------- */}
        <div className="flex flex-col items-center py-10">
            <div className={`w-15 h-15 rounded-full bg-pink-500 flex items-center justify-center mb-2`}>
            ...
            <>
                ...
                <div className="text-gray-300 text-xs font-light">Stagiaire</div>
            </>
            )}
        </div>
        {/* ----------- Nav items -----------  */}
        <nav className="flex-1 flex flex-col items-center justify-center font-light">
            <div className={`flex flex-col justify-center items-center ${collapsed ? "space-y-12" : "space-y-6"}`}>
                <SidebarItem
        ...
        >
            {collapsed ? <ArrowRightFromLine size={10}  /> : <ArrowRightFromLine size={10}  className="rotate-180" />}
        </button>
    </div>
  );
}
